...
Tired of the inefficient debugging of manually traversing vectors and printing them with the stupid `cout <<` one by one?

Try this header-only library 🚀 prints everything including STL containers without pain!
